        ...
        <div class="nav-menu depth-1 col-md-12">
            <ul class="menu">
                ...
                <li class="menu-item text-center<?php echo ($pageID == 9 ? ' active' : ''); ?>">
                    <a class="menu-link" href="<?php echo SITE; ?>OpenClass">เอกสารเปิดชั้นเรียน</a>
                </li>
                <li class="menu-item text-center<?php echo ($pageID == 10 ? ' active' : ''); ?>">
                    <a class="menu-link" href="<?php echo SITE; ?>Project">เอกสารเปิดโครงการ</a>
                </li>
                <li class="menu-item text-center<?php echo ($pageID == 11 ? ' active' : ''); ?>">
                    <a class="menu-link" href="<?php echo SITE; ?>Lecturer">ข้อมูลวิทยากร</a>
                </li>
                <?php } ?>
            </ul>
        </div>
